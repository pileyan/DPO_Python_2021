...
5 занятие (27.02.2021)
[Устройство функций в Python. Написание простейших функций. Lambda-функции. Функция map(). Написание сложных функций. генераторы, Декораторы, Рекурсия.](https://github.com/pileyan/DPO_Python_2021/tree/main/lect05_functions)

5 занятие (04.03.2021)
[O-нотация. Работа с файлами: чтение и запись.](https://github.com/pileyan/DPO_2021_online/tree/master/lect6_O_notation)
...
Ткнуть [сюда](https://docs.google.com/spreadsheets/d/1-u3YJvYKJ8Fb_-icm1Xk9HRBRu3TjxflObmaHKnw5y4/edit?usp=sharing)
